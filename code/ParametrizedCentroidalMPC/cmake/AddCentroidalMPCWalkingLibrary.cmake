...
function(add_centroidal_mpc_walking_library)
  ...
  if(is_interface)
    ...
    install(FILES ${public_headers} DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/CentroidalMPCWalking/${installation_folder}")
    install(FILES ${private_headers} DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/CentroidalMPCWalking/${installation_folder}/impl")
    ...
    install(TARGETS    ${name}
      ...
      PUBLIC_HEADER    DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/CentroidalMPCWalking/${installation_folder}"       COMPONENT dev
      PRIVATE_HEADER   DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/CentroidalMPCWalking/${installation_folder}/impl"  COMPONENT dev)

  endif()

  # add alias
  add_library(CentroidalMPCWalking::${name} ALIAS ${name})
  ...
  set_property(GLOBAL APPEND PROPERTY CentroidalMPCWalking_TARGETS ${name})
